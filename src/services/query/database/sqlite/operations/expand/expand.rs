...
use crate::database::sqlite::common::context::contextualizer::{ContextualizerMetadata, ContextualizerEntityDescription, ContextualizerRelationshipMetadata, ContextualizerRelationshipType};
...
impl Expand {
    pub fn process(
        ...
        if !contextualizer.ignore_rules.expand {
