...
use crate::{dto::metadata::{ColumnMetadata, EntityDescription, EntityMetadata}, services::query::database::sqlite::common::tokens::filter::token::{Increment, Operation, Parentheses, Token}};
...
impl Tokenization {
    fn format_value(value: &str, column_metadata: &ColumnMetadata) -> Result<String, String> {
    ...
    fn get_operation(column_metadata: &ColumnMetadata, tokens_iter: &mut EventfulPeekable<std::slice::Iter<'_, String>>) -> Result<Operation, String> {
    ...
    fn validate_operator(operator: &str, column_metadata: &ColumnMetadata) -> Result<(), String> {
